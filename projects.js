...
const projects = [
    // Intelligent Imaging
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Nature Communications</b> 2026',
    ...
    },
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Nature Biomedical Engineering</b> 2022',
    ...
    },
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Light: Science & Applications</b> 2021',
    ...
    },
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Nature</b> 2025',
    ...
    // Generative AI for Vision
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Siggraph</b> 2026',
    ...
    },
    {
        ...
        direction: 'ai-vision',
        directionLabel: 'Generative AI for Vision',
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">CVPR</b> 2026',
    ...
    },
    {
        ...
        direction: 'ai-vision',
        directionLabel: 'Generative AI for Vision',
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">ICCV</b> 2025',
    ...
    },
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">IEEE TCSVT</b> 2025',
    ...
    // Optics + AI
    {
        ...
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Nature Communications</b> 2023',
    ...
    },
    {
        ...
        direction: 'ai-optics',
        directionLabel: 'Optical Neural Networks',
        status: '<b style="color: #1a202c; border-bottom: 3px solid #3b8276; padding-bottom: 0.5px;">Light: Science & Applications</b> 2022',
